    ...
    <div v-if="!isLoading">
      ...
      <div style="margin-top: 3%;">
        <v-card style="width: 90%; max-width: 1000px; margin-left: auto; margin-right: auto;">
          ...
          ></v-img>
          <p style="font-size:4vh; font-weight: bold; margin-left:3%; padding-top:1%; float:left; color: #f39c14;">
            {{ title }}</p>
          <v-btn style="float:right; margin:2%; " @click="certification(cid)"
                 v-if="alreadyParicipate && todaystate && certificationAvailableTime && ongoing">
            인증하기
          </v-btn>
          <br style="clear:both;"/>
          <div>
        ...
        <v-card
            style="width: 90%; max-width: 1000px; padding: 1% 2%; margin-top: 3%;margin-left: auto; margin-right: auto;">
          ...
          <p style="font-size:2.5vh; margin-top: 2%;">인증 가능 시간 : <span style="font-size:2.5vh; font-weight: bold"> {{ timepick[certificationStartTime] }} ~ {{ timepick[certificationEndTime] }}</span></p>
        ...
        <v-card
          ...
          <p style="font-size:2.5vh; margin-top: 2%;  font-weight: bold; " v-if="challengeState=='before'">현재 까지 {{ gather }} ETH가 모였습니다.</p>
          <p style="font-size:2.5vh; margin-top: 2%;  font-weight: bold; " v-if="challengeState!='before'">도전 금액 : {{ gather }} ETH</p>
        </v-card>
        <v-card
            style="width: 90%; max-width: 1000px; padding: 1% 2%; margin-top: 3%;margin-left: auto; margin-right: auto;">
        ...
        <div style="width:90%; padding: 2%; margin: 0 auto 3%; text-align: center;" v-if="challengeState=='before'">
          ...
          <v-btn color="error" dark large
                 style=" width:40%; height: 8vh; font-size:3vh; font-weight: bold; margin : 0 auto; "
                 v-if="!alreadyParicipate" @click="passwordDialog=true">
            참여하기
          </v-btn>
        </div>
      </div>
