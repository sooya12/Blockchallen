    ...
    <div>
        ...
        <div style="text-align: center; ">
            ...
            ></v-text-field>
                ...
                <div>
                    <p style="text-align: left;" >기간 &nbsp;&nbsp; <span style="color:#ff5555; margin-left: 3%;"> &nbsp;&nbsp;{{ periods }} </span> </p>
                ...
                <div>
                    ...
                    <p style="color:#ff5555; text-align: left;">모집 마감 기간까지 최소 00명이 모이지 않을 시 챌린지가 자동으로 <span style="font-weight: bold;">삭제</span>됩니다.</p>
                </div>
